...
namespace math
{
	typedef struct Mat3
	{
		   ...
		   /*----------*/
			 ...
			 * parameter : 
			 *
			 * return (type bool): return false if reverse is not possible
			 *
			 ...
			 */
			bool	reverse		(math::Mat3& reversMat) const;
	...
	typedef struct Mat4
	{
		   ...
		   /*----------*/
			 ...
			 * Assert if is square or empty
			 */
			bool	reverse		(math::Mat4& reversMat) const;
