...
inline Renderer::Renderer (SDL_Window* win, int winW, int winH)
...
inline void		Renderer::swapBuffer		() noexcept
{
...
inline ColorRGBA alphaBlending(const ColorRGBA& Ca, const ColorRGBA& Cb) //Ca Over Cb
{
...
inline void Renderer::setPixelColor(unsigned int x, unsigned int y, const ColorRGBA& c, unsigned int z)
{
